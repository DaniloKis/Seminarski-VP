<?php $naslov = "Унос пакета (SP)"; require("pogledi/delovi/vrh.php"); ?>

<table style="width:100%;" bgcolor="#f4edd8" cellspacing="0" cellpadding="12" border="0">
<tr><td>
<br/>
<b><font face="Trebuchet MS" color="brown" size="4px">УНОС НОВОГ ПАКЕТА (применом stored procedure)</font></b><br/><br/>

<form method="POST" action="<?php echo OSNOVA; ?>/paket/dodajSP" class="forma-paket" novalidate>
...
<tr><td></td><td><br/><input type="submit" value="СНИМИ (SP)" /> &nbsp; <a href="<?php echo OSNOVA; ?>/paket/index">Назад</a></td></tr>
</table>
</form>
<br/>
</td></tr>
