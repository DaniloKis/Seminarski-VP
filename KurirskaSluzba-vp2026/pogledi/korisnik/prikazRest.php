<?php $naslov = "Корисници (REST)"; require("pogledi/delovi/vrh.php"); ?>
...
<tr><td>
<br/>
<b><font face="Trebuchet MS" color="brown" size="4px">КОРИСНИЦИ (REST)</font></b>
&nbsp;&nbsp;[ <a href="<?php echo OSNOVA; ?>/korisnik/dodajForm">Додај корисника</a> ]<br/>
...
<script src="<?php echo OSNOVA; ?>/js/korisnikRESTObrisi.js"></script>
<script src="<?php echo OSNOVA; ?>/js/korisnikRESTUcitajSve.js"></script>
